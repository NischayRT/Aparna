  ...
  return (
    <>
      ...
      <div className="hidden lg:block fixed top-1/2 right-0 z-40 transform -translate-y-1/2 -rotate-90 origin-bottom-right">
        <button
          className="bg-gradient-to-r from-orange-500 to-amber-500 text-white px-6 py-3 rounded-t-lg shadow-lg hover:shadow-xl transition-all duration-300 font-semibold text-sm uppercase tracking-wide hover:scale-105"
