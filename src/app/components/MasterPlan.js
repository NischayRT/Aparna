...
// NEW: This component is a copy of the updated FloorPlan.js (which is based on Gallery.js)
// It's designed to show tabbed master plans.

const MasterPlan = ({
  title = "Master Plan", // NEW: Title prop
  style,
  budgetOptions = [],
  galleryData = {},
  style1,
  ...
  return (
    <>
      <div className="gallery-section bg-gray-50 py-12 md:py-16 lg:py-20 overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          >
            <div
              ...
              style={{ padding: "0 calc(50% - clamp(300px, 60vw, 700px) / 2)" }}
            >
              {currentImages.map((item, index) => (
                <div
                  ...
                  style={{ width: "clamp(300px, 60vw, 700px)" }} // Wider for master plans
                >
                  <button
            ...
            {currentImageCount > 1 && (
              <>
                <button
                  onClick={handlePrev}
                  className="absolute left-0 top-1/2 -translate-y-1/2 z-10 p-2 bg-white/80 rounded-full shadow-md hover:bg-white transition"
                ...
                <button
                  onClick={handleNext}
                  className="absolute right-0 top-1/2 -translate-y-1/2 z-10 p-2 bg-white/80 rounded-full shadow-md hover:bg-white transition"
