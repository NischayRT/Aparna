...
// --- CHANGE: Removed `submitButton` and `checkboxText` from the props ---
const PopupForm = ({ isOpen, onClose, budgetOptions = [] }) => {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl mx-auto">
        {/* Header */}
          ...
          <div className="mt-6">
            <label className="flex items-start space-x-2">
              ...
              <span className="text-gray-700 text-sm">
                {/* --- CHANGE: Hardcoded checkbox text --- */}
